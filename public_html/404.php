...
<body>
  ...
  <main class="main-content">
    <div style="background-color: white; padding: 4rem 2rem; text-align: center; border-radius: var(--radius-md); box-shadow: var(--shadow-card); margin: 2rem 0;">
      <h1 style="font-size: 5rem; color: var(--color-primary); font-family: var(--font-heading); margin-bottom: 0;">404</h1>
      <h2 style="font-family: var(--font-heading); font-size: 1.8rem; margin-bottom: 1rem; color: var(--color-dark);">Página No Encontrada</h2>
